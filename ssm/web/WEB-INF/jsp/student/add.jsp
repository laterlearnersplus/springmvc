            ...
            <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
                <div class="widget am-cf">
                    ...
                    <div class="widget-body am-fr">
                        ...
                        <form class="am-form tpl-form-border-form tpl-form-border-br" action="${pageContext.request.contextPath}/student/add.html" method="post">
<%--                            <div class="am-form-group">--%>
<%--                                <label  class="am-u-sm-3 am-form-label">学号 <span class="tpl-form-line-small-title">id</span></label>--%>
<%--                                <div class="am-u-sm-9">--%>
<%--                                    <input type="text" class="tpl-form-input" name="student.id" value="" />--%>
<%--                                </div>--%>
<%--                            </div>--%>
                            ...
                            <div class="am-form-group">
                                ...
                                <div class="am-u-sm-9">
<%--                                    <input type="text" class="am-form-field tpl-form-no-bg" name="student.name">--%>
                                    <input type="text" class="am-form-field tpl-form-no-bg" name="name">
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label  class="am-u-sm-3 am-form-label">地址 <span class="tpl-form-line-small-title">gender</span></label>
                                <div class="am-u-sm-9">
                                    <input type="text" class="am-form-field tpl-form-no-bg" name="address">
                                </div>
                            </div>

                            <div class="am-form-group">
                                <label  class="am-u-sm-3 am-form-label">入学时间 <span class="tpl-form-line-small-title">age</span></label>
                                <div class="am-u-sm-9">
                                    <input type="date" class="am-form-field tpl-form-no-bg" name="time">
                                </div>
                            </div>
...
<%--            var optionStr = "<option value='99'>**请选择**</option>";--%>
